...
int main(int argc, char **argv) {
    ...
    viewPlaneResolutionX = 800;
    viewPlaneResolutionY = 800;
    ...
    std::cout << viewPlaneResolutionX << " " << viewPlaneResolutionY << std::endl;

    double start = omp_get_wtime();
    #pragma omp parallel for num_threads(4) schedule(guided) collapse(2)
    ...
    std::cout << "done in " << finish-start << " seconds." << std::endl;
